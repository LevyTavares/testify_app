...
import {
  ...
  ScrollView, Platform, ActivityIndicator, TextInput, Alert // <-- Importa Alert
} from 'react-native';
import { MaterialCommunityIcons } from '@expo/vector-icons';
import { useRouter } from 'expo-router';
import EmptyState from '../components/EmptyState';
// Importa o hook e o tipo Template do Contexto
...
export default function CorrectorScreen() {
    ...
    Alert.alert(
      ...
      [
        { text: "Cancelar", style: "cancel" },
        {
          ...
          onPress: async () => { // Tornamos async para tratar erros potenciais
             try {
  ...
  const handleSaveReport = async () => { // Tornamos async para tratar erros
    if (!studentName) {
    ...
    if (selectedTemplate) {
       try {
          await handleAddReport(selectedTemplate, correctionResult, studentName, studentMatricula, studentTurma);
          setStudentName('');
          setStudentMatricula('');
          setStudentTurma('');
          return true;
       ...
       Alert.alert("Erro", "Nenhum gabarito selecionado para salvar o resultado.");
       return false;
    }
  };
         ...
         <ScrollView contentContainerStyle={styles.scrollContent}>
           <View style={styles.card}>
             ...
             <View style={styles.inputContainer}>
               ...
               <TextInput style={styles.input} placeholder="Digite o nome do aluno" placeholderTextColor="#999" value={studentName} onChangeText={setStudentName}/>
             </View>
             ...
             <View style={styles.inputContainer}>
               ...
               <TextInput style={styles.input} placeholder="Digite a matrícula" placeholderTextColor="#999" value={studentMatricula} onChangeText={setStudentMatricula} keyboardType="numeric"/>
             </View>
             ...
             <View style={styles.inputContainer}>
               ...
               <TextInput style={styles.input} placeholder="Digite a turma" placeholderTextColor="#999" value={studentTurma} onChangeText={setStudentTurma}/>
             </View>
              ...
              <View key={template.id} style={styles.reportItemContainer}>
                ...
                >
                  ...
                  <View style={styles.reportItemTextContent}>
                    <Text style={styles.reportItemTitle} numberOfLines={1}>{template.title}</Text>
...
const styles = StyleSheet.create({
  ...
  reportItem: { // Este estilo não é mais usado diretamente no map, mas pode ser referência
