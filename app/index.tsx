          ...
          >
            ...
            >
              ...
              <View style={styles.heroTextContainer}>
                ...
                <PaperText variant="titleLarge" style={styles.heroButtonText}>
                  Criar um Novo Gabarito
                </PaperText>
                <PaperText
                  variant="bodyMedium"
                  style={styles.heroButtonSubtext}
                >
          ...
          <Link href="/corrector" asChild>
            ...
            >
              ...
              <View style={styles.actionCardContent}>
                ...
                <PaperText variant="titleSmall" style={styles.actionCardText}>
                  Corrigir Provas
                </PaperText>
              </View>
            </TouchableRipple>
