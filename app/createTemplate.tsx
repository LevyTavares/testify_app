...
import {
  ...
  ScrollView, SafeAreaView, StatusBar, Platform, ActivityIndicator // Import ActivityIndicator
} from 'react-native';
import { MaterialCommunityIcons } from '@expo/vector-icons';
import { LinearGradient } from 'expo-linear-gradient';
import { useRouter } from 'expo-router';
// Importa o hook para usar o "cérebro" (Contexto)
...
export default function CreateTemplateScreen() {
  ...
  const [generatedGabaritoUri, setGeneratedGabaritoUri] = useState<string | null>(null); // Guarda a URI (base64) da imagem
  ...
  const handleSaveTemplate = async () => { // Função agora é async
    ...
    const newTemplateData: Omit<Template, 'results' | 'gabaritoImagePath'> = { // Usamos Omit para criar sem results/imagePath
        id: templateId,
        title: tituloProva,
    ...
    try {
        ...
        await handleAddTemplate(newTemplateData.title, newTemplateData.numQuestoes.toString(), newTemplateData.correctAnswers);
    ...
    try {
      ...
      console.log(`Chamando backend em ${backendUrl} com dados:`, { tituloProva, numQuestoes });
          ...
          <View style={styles.card}>
            ...
            <View style={styles.formHeader}>
              ...
              <Text style={styles.infoText}>
                O gabarito "{tituloProva}" foi salvo localmente. Abaixo está a prévia gerada pelo servidor.
              </Text>
            </View>
            ...
            {isGeneratingImage ? (
              <View style={styles.imagePlaceholder}>
                ...
                <Text style={styles.loadingText}>Gerando prévia do gabarito...</Text>
              </View>
              ...
              <View style={styles.imagePlaceholder}>
                <MaterialCommunityIcons name="image-off-outline" size={40} color="#AAAAAA" />
                <Text style={styles.errorText}>Não foi possível carregar a prévia.</Text>
              </View>
            )}
            ...
            <TouchableOpacity
              ...
              onPress={() => alert('Download ainda não implementado com backend.')}
            >
