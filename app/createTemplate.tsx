...
export default function CreateTemplateScreen() {
  ...
  const [correctAnswers, setCorrectAnswers] = useState<{[key: number]: string | null}>({}); // <--- MUDANÇA: Adicionamos tipo (TypeScript)
  ...
  const handleSelectAnswer = (questionNumber: number, answer: string) => { // <--- MUDANÇA: Adicionamos tipos
